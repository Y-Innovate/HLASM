...
><span style="font-family: monospace; white-space: pre">registers  
...
There are many different such machine instructions, the most common ones are for example for fetching some data from memory into a register: `L` (load), storing the contents of a register in memory: `ST` (store), getting the address of some data in memory and putting that address in a register: `LA` (load address), copying some data from one address in memory to another address: `MVC` (move), etc.
...
<span style="font-family: monospace; white-space: pre">         L     2,3</span>  
...
<span style="font-family: monospace; color: gray">----+----1----+----2----+</span>  
<span style="font-family: monospace; white-space: pre">         L     R2,R3</span>  
